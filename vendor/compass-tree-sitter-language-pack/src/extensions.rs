...
mod tests {
    ...
    fn test_path_detection() {
        assert_eq!(detect_language_from_path("src/main.rs"), Some("rust"));
        assert_eq!(
            detect_language_from_path("/path/to/file.py"),
            Some("python")
        );
        assert_eq!(detect_language_from_path("README.md"), Some("markdown"));
    ...
    fn test_compound_extension_app_src_is_erlang() {
        ...
        assert_eq!(
            detect_language_from_path("rel/foo/foo.app.src"),
            Some("erlang")
        );
    ...
    fn test_shebang_direct_python() {
        assert_eq!(
            detect_language_from_content("#!/usr/bin/python\npass"),
            Some("python")
        );
    }
    ...
    fn test_shebang_sh() {
        assert_eq!(
            detect_language_from_content("#!/bin/sh\necho hi"),
            Some("bash")
        );
    }
    ...
    fn test_shebang_unknown_interpreter() {
        assert_eq!(
            detect_language_from_content("#!/usr/bin/env unknownlang\ncode"),
            None
        );
        assert_eq!(
            detect_language_from_content("#!/usr/bin/fantasy\ncode"),
            None
        );
    }
