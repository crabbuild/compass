#!/usr/bin/env python3
"""Qualification-only Swift source oracle (SwiftSyntax-compatible contract)."""
...
def main() -> int:
    ...
    try:
        payload = run_oracle_with_provider(
            ...
            implementation="bounded_lexical_scanner; SwiftSyntax provider unavailable",
            suffixes=(".swift",),
        ...
        print(f"swift source oracle failed: {error}", file=sys.stderr)
        return 1
