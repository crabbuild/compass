export function CompassBrandMark({
  ...
  return (
    <svg
      className={className}
      viewBox={variant === "app" ? "0 0 128 128" : "0 0 24 24"}
      fill="none"
      aria-hidden="true"
    >
      {variant === "app" && (
        <>
          <rect x="6" y="6" width="116" height="116" rx="29" fill="#5865F2" />
          <rect x="7" y="7" width="114" height="114" rx="28" fill="none" stroke="#FFFFFF" strokeOpacity=".22" strokeWidth="2" />
        </>
      )}
      <path
        transform={variant === "app" ? "translate(13.6 13.6) scale(4.2)" : undefined}
        fill={variant === "app" ? "#FFFFFF" : "currentColor"}
        fillRule="evenodd"
        clipRule="evenodd"
