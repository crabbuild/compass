...
| Available now | Python, Go, Rust, and Java are entries in the hard-cut `AdapterRegistry`; Go and Java are at adapter version 3, Rust is at version 10, and Python is at version 11 |
...
Go and Java are at adapter version 3, Rust is at version 10, and Python is at version 11.
