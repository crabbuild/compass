...
| Available now | Python, Go, Rust, and Java are entries in the hard-cut `AdapterRegistry`; Go and Java are at adapter version 3, and Python and Rust are at version 2 |
...
Python and Rust are at adapter version 2, while Go and Java are at version 3.
