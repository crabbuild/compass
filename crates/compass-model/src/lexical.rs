...
pub fn canonical_code_token(token: String) -> String {
    ...
    match token.as_str() {
        ...
        "compacted" | "compacting" => "compact".to_owned(),
        "configured" | "configuring" => "configure".to_owned(),
        "converted" | "converting" => "convert".to_owned(),
        "deleted" | "deleting" => "delete".to_owned(),
        "executed" | "executing" => "execute".to_owned(),
        "merged" | "merging" => "merge".to_owned(),
        "optimized" | "optimizing" => "optimize".to_owned(),
        "restored" | "restoring" => "restore".to_owned(),
