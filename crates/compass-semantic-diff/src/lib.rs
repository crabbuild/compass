...
pub use model::{
    ...
    Compatibility, Completeness, Confidence, DependencyDelta, EvidenceRef, FeatureGroup,
    FindingOrigin, FindingType, GraphDelta, GraphEdgeDelta, GraphNodeDelta, MAX_DIRECT_ENTITIES,
