...
use compass_graph::{
    ...
    GraphSnapshotGcStats, InventoryEvidence, PublicationOmissions, SnapshotSelector,
    build_owned_with_tiebreaker as build_document, canonical_edge_kind, canonical_graph_document,
...
fn build_graph_inner(
    ...
    let mut publication_evidence =
        BuildEvidence::from_document(&root, &raw_document, configuration_digest)?;
