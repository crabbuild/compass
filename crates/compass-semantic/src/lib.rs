...
use compass_files::{FileError, FileSlice, read_slice_text};
use compass_media::extract_text;
use regex::Regex;
...
/// Convert an OpenAI-compatible HTTP response into Compass's semantic result.
