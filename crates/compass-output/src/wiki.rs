...
fn community_article(
    ...
    lines.extend([
        ...
        String::new(),
        format!(
            "*Part of the compass knowledge wiki. See {} to navigate.*",
...
fn index_markdown(
    ...
    let mut output = format!(
        "# Knowledge Graph Index\n\n> Auto-generated by compass. Start here — read community articles for context, then drill into god nodes for detail.\n\n**{total_nodes} nodes · {total_edges} edges · {} communities**\n\n---\n\n## Communities\n(sorted by size, largest first)\n\n",
        communities.len()
    );
    ...
    output.push_str("---\n\n*Generated by [compass](https://github.com/safishamsi/compass)*");
    output
}
